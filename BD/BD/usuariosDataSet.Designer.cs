...
namespace BD {
    ...
    public partial class usuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class personaDataTable : global::System.Data.TypedTableBase<personaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public personaRow AddpersonaRow(string nombre, string pass) {
        ...
        public partial class productoDataTable : global::System.Data.TypedTableBase<productoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public productoRow AddproductoRow(string descripcion, string serie, System.DateTime fecha) {
        ...
        public partial class personaRow : global::System.Data.DataRow {
            ...
            public string pass {
                get {
                    return ((string)(this[this.tablepersona.passColumn]));
                }
                set {
                    this[this.tablepersona.passColumn] = value;
                }
            }
        }
        ...
        public partial class productoRow : global::System.Data.DataRow {
            ...
            public string serie {
                get {
                    return ((string)(this[this.tableproducto.serieColumn]));
                }
                set {
                    this[this.tableproducto.serieColumn] = value;
                }
            }
...
namespace BD.usuariosDataSetTableAdapters {
    ...
    public partial class personaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[persona] ([nombre], [pass]) VALUES (@nombre, @pass);\r\nSELECT i" +
                "d, nombre, pass FROM persona WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[persona] SET [nombre] = @nombre, [pass] = @pass WHERE (([id] = @Ori" +
                "ginal_id) AND ([nombre] = @Original_nombre) AND ([pass] = @Original_pass));\r\nSEL" +
                "ECT id, nombre, pass FROM persona WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BD.Properties.Settings.Default.usuariosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, pass FROM dbo.persona";
        ...
        public virtual int Fill(usuariosDataSet.personaDataTable dataTable) {
        ...
        public virtual usuariosDataSet.personaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            usuariosDataSet.personaDataTable dataTable = new usuariosDataSet.personaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(usuariosDataSet.personaDataTable dataTable) {
    ...
    public partial class productoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[producto] WHERE (([id] = @Original_id) AND ([descripcion] = @O" +
                "riginal_descripcion) AND ([serie] = @Original_serie) AND ([fecha] = @Original_fe" +
                "cha))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[producto] ([descripcion], [serie], [fecha]) VALUES (@descripci" +
                "on, @serie, @fecha);\r\nSELECT id, descripcion, serie, fecha FROM producto WHERE (" +
                "id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[producto] SET [descripcion] = @descripcion, [serie] = @serie, [fecha] = @fecha WHERE (([id] = @Original_id) AND ([descripcion] = @Original_descripcion) AND ([serie] = @Original_serie) AND ([fecha] = @Original_fecha));
SELECT id, descripcion, serie, fecha FROM producto WHERE (id = @id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT id, descripcion, serie, fecha FROM dbo.producto";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(usuariosDataSet.productoDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual usuariosDataSet.productoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            usuariosDataSet.productoDataTable dataTable = new usuariosDataSet.productoDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(usuariosDataSet.productoDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_id, string Original_descripcion, string Original_serie, System.DateTime Original_fecha) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string descripcion, string serie, System.DateTime fecha) {
            if ((descripcion == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string descripcion, string serie, System.DateTime fecha, int Original_id, string Original_descripcion, string Original_serie, System.DateTime Original_fecha, int id) {
            if ((descripcion == null)) {
                throw new global::System.ArgumentNullException("descripcion");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string descripcion, string serie, System.DateTime fecha, int Original_id, string Original_descripcion, string Original_serie, System.DateTime Original_fecha) {
            return this.Update(descripcion, serie, fecha, Original_id, Original_descripcion, Original_serie, Original_fecha, Original_id);
        }
    }
